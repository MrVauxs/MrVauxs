			...
			<header class="pb-1 pt-6">
				<div>
					<img
						...
						alt="Vauxs Robot GIF"
					/>
					<h1 class="inline-flex h1 gradient-heading">Vauxs</h1>
				</div>
				<i class="text-xs">Also known as MrVauxs, ThatVauxs, etc.</i>
			</header>
			<span>
				<p />
...
<style lang="postcss">
	.gradient-heading {
		...
		/* Color Stops */
		@apply from-primary-200 via-tertiary-400 to-secondary-600;
	}
</style>
